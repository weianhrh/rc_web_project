...
<script>
  ...
  function changePeriod(p){
    window.location.href = buildUrl('/api/index/user_register_detail.php', {period: p});
  }
  ...
  function clearRange(){
    ...
    window.location.href = buildUrl('/api/index/user_register_detail.php', {start_date: null, end_date: null});
  }
