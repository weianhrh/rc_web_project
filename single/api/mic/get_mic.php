<?php
// /api/mic/get_mic.php
// 获取设备麦克风/咪头输入音量配置 fVideo.VolumeIn
...
try {
    ...
    debugLog('INCOMING_GET_MIC_REQUEST', [
    ...
    // 3. 获取麦克风输入音量
    $configRes = getMicVolumeConfig($deviceToken, $channel);
    ...
    $config = $configRes['json']['data']['fVideo.VolumeIn'] ?? null;
    ...
    jsonOut([
        ...
        'data' => [
            ...
            'mic' => slimResponse($configRes),
        ],
    ]);

} catch (Throwable $e) {
    debugLog('GET_MIC_EXCEPTION', [
